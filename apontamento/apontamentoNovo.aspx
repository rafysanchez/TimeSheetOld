                ...
                <ContentTemplate>
                    ...
                    <table>
                        <tr>
                            ...
                            <td valign="middle">
                                &nbsp;&nbsp;<span style="font-size:12px;">Mês</span>
                                <asp:DropDownList ID="ddlMes" runat="server" Width="110">
                                </asp:DropDownList>
                            </td>
                            <td valign="middle">
                                &nbsp;&nbsp;<span style="font-size:12px;">Ano:</span>
                                <asp:DropDownList ID="ddlAno" runat="server" Width="90">
                                </asp:DropDownList>
                            </td>
                            <td valign="middle">
                                &nbsp;&nbsp;&nbsp;<asp:Button ID="btnApontarHora" runat="server" Text="Apontar Hora" />
                            </td>
                        </tr>
                    </table>                
            ...
            <asp:UpdatePanel ID="UpdatePanelTabelaApontamento" runat="server">
                <ContentTemplate>
                    ...
                    <div id="divTabelaApontamento" runat="server" style="font-family:Verdana; font-size:12px;">
                        ...
                        <div style='font-family:@Arial Unicode MS; font-style:italic; font-size:medium; display:none; 
                            color:Red;' align='left'>                       
                            <asp:Label ID="lblAlerta" runat="server" ></asp:Label> <br /> <br />
                        </div>                  
                        ...
                        <table>
                            ...
                            <tr align="right">
                                ...
                                <td style="background-color:#E4E4E4;" align="center">
                                    <input type="text" style="background-color:#E4E4E4; border-style:none; width:50px; 
