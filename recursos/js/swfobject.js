...
var swfobject = function() {
	...
	*/
	...
	/* Onload cruzado de navegador
		- Com base na solução de James Edwards: http://brothercake.com/site/resources/scripts/onload/
	...
	*/
	...
	/* Libera memória para evitar vazamentos causados por fechamentos, reparar threads de áudio/vídeo pendurados e forçar a desconexão de soquetes/NetConnections afpAbertos (apenas no Internet Explorer)
	*/
	var cleanup = function() {
		if (ua.ie && ua.win) {
			window.attachEvent("onunload", function() {
				...
				// limpeza dinâmica dos objetos incorporados para consertar os threads de áudio/vídeo e forçar a desconexão de soquetes afpAbertos e NetConnections
