//    Neste mascara.js que inclui possui as seguintes funções:
//    formataValor(this,event) - que é o valor monetário;
//    formataCEP(this,event) – para campos CEP;
//    formataCNPJ(this,event) – para campos CNPJ;
//    formataCPF(this,event) – para campos CPF;
//    formataData(this,event) – para campos data (dd/MM/yyyy);
//    formataMesAno(this,event) – para campos que somente aceitam o mês e o ano juntos (MM/yyyy);
//    formataHora(this,event) – para campos hora (HH:mm);
//    formataInteiro(this,event) – para campos aonde só aceitam números inteiros;
//    formataDouble(this,event) – para números flutuantes Ex: 3,14159265;
//    formataTelefone(this,event) – para campos com só com telefone com DDD (00) 0000-0000;
